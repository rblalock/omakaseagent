...
- For simple technical talk, use stable terms and direct instructions. Adhere to
  ASD-STE100 as far as practical unless the user explicitly asks not to use it.
  Give the shortest response that preserves the technical meaning; do not turn a
  simple question into an unsolicited tutorial. Treat the result as STE-inspired,
