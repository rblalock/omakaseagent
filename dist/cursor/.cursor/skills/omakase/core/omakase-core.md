...
- **Simple technical talk:** load `reference/prose.md` **STE-inspired technical clarity** by default; adhere to ASD-STE100 as far as practical, give the shortest sufficient answer, and never claim formal compliance without full validation. Use neutral **Technical clarity** only when the user explicitly opts out of ASD-STE100 guidance.
